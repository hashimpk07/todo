    ...
    <input type="hidden" name="id" class="form-control" id="id" value="<?php echo e($todo->id); ?>">
        <div class="form-group">
            <label for="name"> Name <span style="color:#ff0000">*</span></label>
                <input type="text" name="name" class="form-control" id="name"  value="<?php echo e($todo->title); ?>" placeholder="Enter To Do Name ">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                        <input type="date" class="form-control" id="dueDate" name="dueDate" value="<?php echo e($todo->due_date); ?>" >
                    </div>
        ...
        <div class="form-group">
            ...
            <textarea  type="textarea" name="description" class="form-control" id="description" placeholder="Description"  rows="4" cols="50"><?php echo e($todo->description); ?></textarea>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">  
        ...
        if( 1 == todoFlag ){
            ...
            $.ajax({
                url:"<?php echo e(route('todo.update')); ?>",
                type: "POST",
                dataType: "json",
                data:{ 
                    id : id,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\todo-app\resources\views/todo/todo-edit.blade.php ENDPATH**/ ?>