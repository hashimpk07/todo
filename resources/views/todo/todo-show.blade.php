    ...
    <input type="hidden" name="id" class="form-control" id="id" value="{{$todo->id}} ">
        <div class="form-group">
            <label for="name"> Name <span style="color:#ff0000">*</span></label>
                <input type="text" name="name" class="form-control" id="name"  value="{{$todo->title}}" placeholder="Enter To Do Name " disabled>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                        <input type="date" class="form-control" id="dueDate" name="dueDate" value="{{$todo->due_date}}" disabled>
                    </div>
        ...
        <div class="form-group">
            ...
            <textarea  type="textarea" name="description" class="form-control" id="description" placeholder="Description"  rows="4" cols="50" disabled>{{$todo->description}}</textarea>
        </div>
